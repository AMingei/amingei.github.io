...
const data = {\r
	thead: [\r
		{ id: Col.Method,      label: Col.Method.description,     isSticky: true },\r
		{ id: Col.Parameters,  label: Col.Parameters.description  },\r
		{ id: Col.ReturnValue, label: Col.ReturnValue.description },\r
		{ id: Col.Description, label: Col.Description.description },\r
	],\r
	tbody: [{\r
		key: 1,\r
