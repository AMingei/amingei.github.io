const t=`<template>\r
	<ex-flex vertical>\r
		<ex-flex>\r
			<ex-radio-group name="example-disabled" v-model="currentValue_1">\r
				<ex-flex>\r
					<ex-radio v-for="force in threeKingdoms_1"\r
					:key="force.index"\r
					:value="force.index"\r
...
\r
		<ex-flex style="align-items: baseline;">\r
			<ex-radio-group name="example-readonly" v-model="currentValue_2">\r
				<ex-flex>\r
					<ex-radio v-for="force in threeKingdoms_2"\r
					:key="force.index"\r
					:value="force.index"\r
			...
			<span>\r
				...
				<ex-button type="primary" style="font-size: calc(1rem - 2px)" @click="currentValue_2=2">click this</ex-button>\r
				<br/>\r
				当只读选项被选中时选项组内的其他选项同样无法被直接更改。\r
				<ex-button type="primary" style="font-size: calc(1rem - 2px)" @click="currentValue_2=0">click this</ex-button>\r
			</span>\r
		</ex-flex>\r
\r
		<ex-flex>\r
			<ex-radio-group disabled\r
			name="example-disabled-group" v-model="currentValue_3">\r
				<ex-flex>\r
					<ex-radio v-for="force in threeKingdoms_3 as typeof threeKingdoms"\r
					:key="force.index"\r
					:value="force.index">\r
						{{ force.label }}\r
					</ex-radio>\r
		...
		\r
		<ex-flex>\r
			<ex-radio-group readonly\r
			name="example-readonly-group" v-model="currentValue_4">\r
				<ex-flex>\r
					<ex-radio v-for="force in threeKingdoms_4 as typeof threeKingdoms"\r
					:key="force.index"\r
					:value="force.index">\r
						{{ force.label }}\r
					</ex-radio>\r
			...
			<span>\r
				在单选组上进行组只读。\r
				<ex-button type="primary" style="font-size: calc(1rem - 2px)" @click="currentValue_4 = ++currentValue_4 % 3">click this</ex-button>\r
			</span>\r
		</ex-flex>\r
	</ex-flex>\r
</template>\r
