const t=`<template>\r
	<ex-flex vertical>\r
		<ex-flex>\r
			<ex-button type="primary" @click="current_page--" :disabled="current_page === 1">last page</ex-button>\r
			<ex-button type="primary" @click="current_page++" :disabled="current_page === Math.ceil(data_length / page_size)">next page</ex-button>\r
		</ex-flex>\r
