const t=`<template>\r
	<wtf-space>\r
		<wtf-card width="320px" height="345px" :innerStyle="{ textIndent: '2em' }">\r
			<template #header>第一回<br />宴桃园豪杰三结义 斩黄巾英雄首立功</template>\r
			<template #option>\r
				<a href="javascript: void(0)">分享</a>\r
			</template>\r
			...
			<template #footer>\r
				<a href="javascript: void(0)">查看更多……</a>\r
			</template>\r
		</wtf-card>\r
		<wtf-card width="320px" height="345px">\r
